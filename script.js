...
function drawCarBody(ctx) {
  ...
  roundedRect($.ctx, "#EF1A2D", startX + 6 + ($.state.turn * 1.1), startY - 18, 146, 40, 18);
  ...
  ctx.beginPath(); 
  ctx.lineWidth="12";
  ctx.fillStyle="#f65858";
  ctx.strokeStyle="#f65858";
  ctx.moveTo(startX + 30, startY);
  ...
  roundedRect(ctx, "#111", startX - 4, startY, 169, 10, 3, true, 0.2);
  roundedRect(ctx, "#111", startX + 40, startY + 5, 80, 10, 5, true, 0.1);
